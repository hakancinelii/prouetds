...
export const tripsApi = {
  ...
  getStats: (params?: any) => api.get('/api/trips/stats', { params }),
...
export const tenantsApi = {
  ...
  updateAdminCredentials: (id: string, data: { email?: string; password?: string }) =>
    api.post(`/api/tenants/${id}/admin-credentials`, data),
